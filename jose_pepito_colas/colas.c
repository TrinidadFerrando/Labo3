...
int enviar_mensaje(int id_cola_mensajes, long tipo_msg_a_enviar, int remitente_a_enviar, int evento_a_enviar, char *contenido_msg_a_enviar){
	mensaje msg;
	msg.tipo_msg = tipo_msg_a_enviar;
	msg.remitente = remitente_a_enviar;
...
int recibir_mensaje(int id_cola_mensajes, long tipo_msg_a_recibir, mensaje *msg_a_recibir){
	mensaje msg;
	int rcv;
	rcv = msgrcv(id_cola_mensajes, (struct msgbuf *)&msg, sizeof(msg.remitente) + sizeof(msg.evento) + sizeof(msg.contenido_msg), tipo_msg_a_recibir, 0);
